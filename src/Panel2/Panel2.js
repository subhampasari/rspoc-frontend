...
// Contains the panel to assign experiences, products and features to a ref-marker
class Panel2 extends Component {
    ...
    // function to reset values of state variables
    resetPreviewValues() {
        this.setState({
            showingPreviewData: false,
            previewExperience : "",
    ...
    clickPreviewButton = (e) =>  {  // handles clicking the preview button
        e.preventDefault();
        this.setState({
            showingPreviewData: false,
        });
